# -*- coding: utf-8 -*-
"""
Created on Thu Sep 18 09:07:43 2025
...
output_nc1 = f"/home/riset_2/WRF/WRFDA_Script/{basename}_dbz.nc"
...
ncfile.description = 'Reflectivity'
ncfile.institution = 'DMU BMKG'
ncfile.title = 'PPI-Reflectivity Radar'
...
dbz = ncfile.createVariable('dBZ', 'd', ('lat', 'lon', 'lev'), zlib=True)
